...
public class TestDoubleLinkedList extends BaseTest {
     ...
     * 
     * 
     * Test bad input: Does delete behave correctly if the user tries passing 
     * in invalid input? (E.g. do you throw the correct exception?)
     * 
     */
    //public T delete(int index);
    @Test(timeout=SECOND)
    public void testDeleteItemAtGivenIndex() {
    	IList<Integer> list = this.makeInstance();
        list.add(1);
        list.add(2);
        list.add(3);
        ...
        list.delete(1);
        //elements should shift location after delete and now index 1 should point to 3 
        assertListMatches(new Integer[]{1, 3, 4}, list);
    ...
    public void testDeleteEdgeCases() {
        ...
        list.delete(7);
        list.delete(0);
        //elements should shift locations after delete 
        assertListMatches(new Integer[]{2, 3, 4, 5, 6, 7}, list);
    }
    
    @Test(timeout=SECOND)
    public void testDeleteListUpdate() {
    		IList<String> list = this.makeBasicList();
    		list.delete(1);
    ...
    @Test(timeout=SECOND)
    public void testDeleteWithBadInput() {
    		IList<String> list = this.makeBasicList();
    		try {
    	        list.delete(123);
    	        // If it somehow succeeds, that's bad, and we want to fail.
